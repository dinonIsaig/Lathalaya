        ...
        <form method="#" action="#" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative rounded-md shadow-sm">
                    ...
                    <div>
                        <input type="text" name="full_name" id="full_name" class="input-field" placeholder="John Doe">
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative rounded-md shadow-sm">
                    ...
                    <input type="email" name="email" id="email" class="input-field" placeholder="JohnDoe@gmail.com">
                </div>
            </div>
            ...
            <div>
                <label for="comfirm_password" class="mb-2 block text-sm text-gray-700">
                    Confirm Password
                </label>
                <div class="relative rounded-md shadow-sm">
                    <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                    ...
                    <input type="password" name="confirm_password" id="confirm_password" class="input-field" placeholder="Password123">
                    <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                        <button type="button" class="text-gray-400 hover:text-gray-600 focus:outline-none">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
            ...
            <div class="flex gap-2 justify-center mt-4">
                ...
                <a href="{{ route('author.login') }}" class="font-semibold text-button  hover:underline">Sign In</a>
            </div>
