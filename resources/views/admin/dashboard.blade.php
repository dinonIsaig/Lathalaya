            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 pb-5">
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5 flex justify-between items-start">
                    <div>
                        ...
                        <h1 class="text-2xl font-bold text-slate-900">6</h1>
                    </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5 flex justify-between items-start">
                    <div>
                        ...
                        <h1 class="text-2xl font-bold text-slate-900">4</h1>
                    </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5 flex justify-between items-start">
                    <div>
                        ...
                        <h1 class="text-2xl font-bold text-slate-900">1</h1>
                    </div>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-6 py-4 flex items-center gap-4">
                                    <img src="{{ asset('assets/images/defaultImg.jpg') }}" class="w-12 h-10 rounded-lg object-cover" alt="Article Thumbnail">
                                    <div> 
                                        <p class="font-bold text-black text-sm">Space Exploration: New</p>
                                        <p class="text-slate-500 text-xs truncate w-48">Rover findings suggest ancient...</p>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-sm text-slate-600">Emma Writer</td>
                                <td class="px-6 py-4">
                                    <span class="category-tag">Science</span>
                                </td>
                                <td class="px-6 py-4 text-sm text-slate-500">Jan 13, 2026</td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-3">
                                        ...
                                        <button class="normal-btn py-1 text-sm">Publish</button>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
