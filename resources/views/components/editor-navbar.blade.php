    ...
    <div class="max-w-full mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center gap-10">
            ...
            <div class="hidden md:flex items-center gap-8">
                <a href="{{ route('editor.dashboard') }}" class="nav-text {{ Request::routeIs('editor.dashboard') ? 'text-primary border-primary font-bold' : '' }}">Dashboard</a>
            </div>
        </div>
        ...
        <div class="flex items-center gap-4">
            ...
            <form method="POST" action="{{ route('logout') }}" class="inline">
                @csrf
                <button type="submit" class="text-neutral-gray hover:text-primary transition-colors p-1 pr-5 cursor-pointer">
