    ...
    <div class="max-w-full mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center gap-10">
            ...
            <div class="hidden md:flex items-center gap-8">
                <a href="{{ route('editor.dashboard') }}" class="nav-text {{ Request::routeIs('admin.home') ? 'text-primary border-primary font-bold' : 'text-primary hover:text-neutral-gray'}}">Dashboard</a>
            </div>
        </div>
        ...
        <div class="flex items-center gap-4">
            <div class="flex items-center gap-3 bg-neutral-light px-3 py-1.5 rounded-lg ring-1 ring-black/5">
                ...
                <div class="hidden sm:block text-left leading-tight">
                    <p class="text-sm  text-text-primary">{{ $user->first_name ?? 'Guest Editor' }} {{ $user->last_name ?? '' }}</p>
